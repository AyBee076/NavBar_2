      ...
      <section className="mb-20">
        <div className="flex flex-col text-center mb-10">
          ...
          <p className="">
            ...
            and high-quality pieces designed for confidence and comfort. <br />{" "}
        ...
        <div className="flex flex-col md:flex-row gap-5 px-4">
          <div>
            <Image src={Women1} alt="Women 1" className="rounded-4xl h-full " />
          </div>
          <div>
            <Image src={Women2} alt="Women 2" className="rounded-4xl h-full" />
          </div>
          <div>
            <Image src={Women3} alt="Women 3" className="rounded-4xl h-full" />
          </div>
        </div>
      </section>
    </div>
